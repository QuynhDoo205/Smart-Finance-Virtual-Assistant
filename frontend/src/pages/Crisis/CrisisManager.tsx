          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-xl bg-orange-500/10 border border-orange-500/20">
              <div>
                ...
                <p className="text-sm text-gray-300 mt-1">Đã vượt 120% ngân sách tháng này.</p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Đủ duy trì sinh hoạt trong 2.5 tháng (An toàn).</p>
              </div>
        ...
        <motion.div variants={itemVars} className="glass-panel p-8 rounded-3xl border-rose-500/20 relative overflow-hidden group">
          ...
          <ul className="space-y-4">
            <li className="flex items-start gap-3 p-3 rounded-xl hover:bg-white/5 transition-colors group cursor-pointer border border-transparent hover:border-white/10">
              ...
              <div>
                <strong className="text-white block group-hover:text-rose-400 transition-colors">Tạm khoá thẻ Tín dụng phụ</strong>
                <span className="text-sm text-gray-400 leading-relaxed block mt-1">Hạn chế các khoản quẹt thẻ không kiểm soát trong 14 ngày tới.</span>
              </div>
            </li>
            ...
            <li className="flex items-start gap-3 p-3 rounded-xl hover:bg-white/5 transition-colors group cursor-pointer border border-transparent hover:border-white/10">
              ...
              <div>
                <strong className="text-white block group-hover:text-amber-400 transition-colors">Kích hoạt Chế độ "Thắt lưng buộc bụng"</strong>
                <span className="text-sm text-gray-400 leading-relaxed block mt-1">Nova AI sẽ nhắc nhở mạnh tay hơn và tự động ẩn số dư thẻ tín dụng để tránh cám dỗ.</span>
              </div>
            </li>
          </ul>
        </motion.div>
